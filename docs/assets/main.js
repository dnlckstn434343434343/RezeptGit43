...
var $author$project$Page$Einkaufslisten$view = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
						...
						[
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$width('100'),
									$elm$svg$Svg$Attributes$height('100'),
									$elm$html$Html$Attributes$href('/SVGs/apple.svg')
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$width('100'),
									$elm$svg$Svg$Attributes$height('100'),
									$elm$html$Html$Attributes$href('/SVGs/banana.svg')
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$width('100'),
									$elm$svg$Svg$Attributes$height('100'),
									$elm$html$Html$Attributes$href('/SVGs/carrot.svg')
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$width('100'),
									$elm$svg$Svg$Attributes$height('100'),
									$elm$html$Html$Attributes$href('/SVGs/tomato.svg')
								]),
							_List_Nil)
						]))
				])),
				...
				[
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$width('100'),
							$elm$svg$Svg$Attributes$height('100'),
							$elm$html$Html$Attributes$href('/SVGs/einkaufswagen.svg')
						]),
					_List_Nil)
				]))
		]));
...
var $author$project$Page$Lieblingsrezepte$view = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Speichere hier deine Lieblingsrezepte')
				])),
			A2(
			$elm$html$Html$label,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$for('recipeName')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Name des Rezeptes')
				])),
			A2(
			$elm$html$Html$input,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$name('recipeName'),
					$elm$html$Html$Attributes$placeholder('Name des Rezeptes'),
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$for('ingredients')
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Schwierigkeit')
				])),
			A2(
			$elm$html$Html$select,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$for('preparationTime')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Zubereitungszeit in min.')
				])),
			A2(
			$elm$html$Html$input,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$name('preparationTime'),
					$elm$html$Html$Attributes$placeholder('Zubereitungszeit in min.'),
