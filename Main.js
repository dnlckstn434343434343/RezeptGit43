...
var $author$project$Main$GOTnewRecipe = function (a) {
	return {$: 'GOTnewRecipe', a: a};
};
var $author$project$Main$defaultRecipe = {description: 'Please try again', id: '', name: 'No recipe found'};
...
var $author$project$Main$HTTPSearchResults = function (meals) {
	return {meals: meals};
};
...
var $author$project$Main$mealsDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$Recipe,
	A2($elm$json$Json$Decode$field, 'idMeal', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'strMeal', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'strInstructions', $elm$json$Json$Decode$string));
var $author$project$Main$recipeDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Main$HTTPSearchResults,
	A2(
		$elm$json$Json$Decode$field,
		'results',
		$elm$json$Json$Decode$list($author$project$Main$mealsDecoder)));
					...
					$elm$http$Http$request(
						{
							...
							expect: A2($elm$http$Http$expectJson, $author$project$Main$GOTnewRecipe, $author$project$Main$recipeDecoder),
							headers: _List_Nil,
							method: 'GET',
			...
			default:
				...
				if (httpResponse.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{recipe: $author$project$Main$defaultRecipe}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{error: 'Fehlerhafte Antwort'}),
						$elm$core$Platform$Cmd$none);
				}
		}
	});
var $author$project$Main$GETnewRecipe = {$: 'GETnewRecipe'};
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Events$onClick($author$project$Main$GETnewRecipe)
											]),
										_List_Nil),
										A2(
										$elm$html$Html$div,
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.HTTPSearchResults":{"args":[],"type":"{ meals : List.List Main.Recipe }"},"Main.Recipe":{"args":[],"type":"{ id : String.String, name : String.String, description : String.String }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"GETnewRecipe":[],"GOTnewRecipe":["Result.Result Http.Error Main.HTTPSearchResults"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));